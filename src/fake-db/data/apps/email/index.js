...
let data = {
  ...
  emailTags: [
    ...
    { text: 'K.I.', value: 'ai', color:"primary"},
    { text: 'Datenschutz', value: 'dataprotection', color:"warning"},
    { text: 'Gesetzliche Anforderungen', value: 'legalrequirements', color:"danger"},
  ]
}
